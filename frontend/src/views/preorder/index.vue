  ...
  <div class="preorder-page">
    <el-card shadow="never">
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            <el-button type="primary" :icon="Plus" @click="handleAdd">新建采购预订</el-button>
          </div>
        </div>
      </template>
      ...
      <el-table :data="tableData" stripe border v-loading="loading">
        ...
        <el-table-column prop="partner_name" label="供应商" min-width="150" />
    ...
    <!-- 新增/编辑预订单弹窗 -->
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑预订单' : '新建预订单'" width="900px" destroy-on-close>
      <el-form :model="formData" :rules="rules" ref="formRef" label-width="100px">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="供应商" prop="partner_id">
              <el-select
    ...
    <!-- 预订单详情弹窗 -->
    <el-dialog v-model="detailVisible" title="预订单详情" width="800px" destroy-on-close>
    ...
    <!-- 转单确认弹窗 -->
    <el-dialog v-model="convertVisible" title="采购预定转采购单" width="450px" destroy-on-close>
      <el-alert
      ...
      <p style="color: #909399; font-size: 14px;">
        转单后将生成对应的采购单，预订单状态将变为"已转单"。此操作不可撤销。
      </p>
      <template #footer>
...
const rules = {
  partner_id: [{ required: true, message: '请选择供应商', trigger: 'change' }]
}
...
const convertMessage = computed(() => {
  ...
  return `预订单 ${currentOrder.value.pre_order_no} 将被转为采购单`
})
