...
class InventoryIn(db.Model):
    ...
    warehouse_id = db.Column(BigIntPK, default=1)
...
class InventoryInItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    in_id = db.Column(BigIntPK, nullable=False)
...
class InventoryOut(db.Model):
    ...
    audit_time = db.Column(db.DateTime)
    remark = db.Column(db.Text)
    related_order_id = db.Column(BigIntPK)
...
class InventoryOutItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    out_id = db.Column(BigIntPK, nullable=False)
    product_id = db.Column(BigIntPK)
    product_code = db.Column(db.String(50))
    product_name = db.Column(db.String(200))
    specification = db.Column(db.String(100))
...
class InventoryCheck(db.Model):
    ...
    warehouse_id = db.Column(BigIntPK, default=1)
    warehouse_name = db.Column(db.String(50))
    shelf_id = db.Column(BigIntPK)  # 货架ID
...
class InventoryCheckItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    check_id = db.Column(BigIntPK, nullable=False)
    product_id = db.Column(BigIntPK)
    product_code = db.Column(db.String(50))
    product_name = db.Column(db.String(200))
    specification = db.Column(db.String(100))
...
class TransferOrder(db.Model):
    ...
    from_warehouse_id = db.Column(BigIntPK)
    from_warehouse_name = db.Column(db.String(50))
    to_warehouse_id = db.Column(BigIntPK)
    ...
    operator_id = db.Column(BigIntPK)  # 经手人ID
...
class TransferOrderItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    transfer_id = db.Column(BigIntPK, nullable=False)
    product_id = db.Column(BigIntPK)
    product_code = db.Column(db.String(50))
    product_name = db.Column(db.String(200))
    specification = db.Column(db.String(100))
...
class AssembleOrder(db.Model):
    ...
    product_id = db.Column(BigIntPK)  # 组装成品ID
    product_name = db.Column(db.String(200))
...
class AssembleOrderItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    assemble_id = db.Column(BigIntPK, nullable=False)
    product_id = db.Column(BigIntPK)
    product_code = db.Column(db.String(50))
    product_name = db.Column(db.String(200))
    specification = db.Column(db.String(100))
...
class PreOrder(db.Model):
    ...
    related_order_id = db.Column(BigIntPK)  # 转换后的单据ID
    related_order_no = db.Column(db.String(50))
    remark = db.Column(db.Text)
    created_at = db.Column(db.DateTime, default=datetime.now)
    updated_at = db.Column(db.DateTime, default=datetime.now, onupdate=datetime.now)
...
class PreOrderItem(db.Model):
    ...
    id = db.Column(BigIntPK, primary_key=True, autoincrement=True)
    pre_id = db.Column(BigIntPK, nullable=False)
    product_id = db.Column(BigIntPK)
    product_code = db.Column(db.String(50))
    product_name = db.Column(db.String(200))
    quantity = db.Column(db.Numeric(10, 2), default=0)
