...
class FinanceReceivable(db.Model):
    ...
    related_id = db.Column(db.BigInteger)  # 关联单据ID
    related_no = db.Column(db.String(50))  # 关联单据号
    customer_id = db.Column(db.BigInteger)  # 客户ID
    ...
    invoice_id = db.Column(db.BigInteger)  # 关联发票ID
...
class FinancePayable(db.Model):
    ...
    related_id = db.Column(db.BigInteger)  # 关联单据ID
    related_no = db.Column(db.String(50))  # 关联单据号
    supplier_id = db.Column(db.BigInteger)  # 供应商ID
...
class PurchaseInvoice(db.Model):
    ...
    purchase_order_id = db.Column(db.BigInteger)  # 关联采购单ID
...
class Salary(db.Model):
    ...
    user_id = db.Column(db.BigInteger, nullable=False)  # 员工ID
    ...
    account_id = db.Column(db.BigInteger)  # 发放账户ID
